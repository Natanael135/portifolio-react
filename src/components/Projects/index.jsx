...
const projectsData = [
  {
    ...
    description:
      "Aplicação web e mobile para consulta de horários de viagens das topiques (transporte alternativo) em Sobral e região. Desenvolvido para facilitar o acesso à informação de transporte público alternativo, com interface intuitiva, pesquisa rápida e opção de download do app para dispositivos móveis.",
    ...
    demoUrl: "https://viatopic.netlify.app/",
    codeUrl: null,
  },
  {
    id: 2,
